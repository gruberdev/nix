{
  ...
  in {
    ...
    theme =
      ...
      // {
        additionalCss = ''
          ...
          /* user settings */
          :root {
              --font-family: "${config.font}", system-ui, sans-serif;
              /*
          ...
          *:not([style*="lyric" i] *, [class*="lyric" i], .main-entityHeader-title) {
          ...
          .main-coverSlotCollapsed-container {
              display: var(--display-coverart-image) !important;
          }
          ...
          */
          ...
          .main-cardImage-container,
          .main-cardImage-circular,
          .main-cardImage-square {
              display: var(--display-card-image) !important;
          }

          /* Keep now playing cover art visible */
          .main-nowPlayingBar-nowPlayingBar .main-image-image,
          .main-nowPlayingBar-nowPlayingBar .cover-art,
          .main-nowPlayingBar-nowPlayingBar .cover-art-image,
          .main-nowPlayingView-nowPlayingView .main-image-image,
          .main-nowPlayingView-nowPlayingView .cover-art,
          .main-nowPlayingView-nowPlayingView .cover-art-image,
          .player-controls .main-image-image,
          .now-playing .main-image-image {
              display: block !important;
          }

          /* Ensure album titles and text are visible */
          .main-card-cardTitle,
          .main-card-cardSubtitle,
    ...
    colorScheme = "custom";
    customColorScheme = {
      accent = "${builtins.substring 1 6 config.theme.accent}";
      accent-active = "${builtins.substring 1 6 config.theme.accent}";
      accent-inactive = "${builtins.substring 1 6 config.theme.surface}";
      banner = "${builtins.substring 1 6 config.theme.accent}";
      border-active = "${builtins.substring 1 6 config.theme.accent}";
      border-inactive = "${builtins.substring 1 6 config.theme.overlay}";
      header = "${builtins.substring 1 6 config.theme.muted}";
      highlight = "${builtins.substring 1 6 config.theme.subtle}";
      main = "${builtins.substring 1 6 config.theme.background}";
      notification = "${builtins.substring 1 6 config.theme.cyan}";
      notification-error = "${builtins.substring 1 6 config.theme.error}";
      subtext = "${builtins.substring 1 6 config.theme.muted}";
      text = "${builtins.substring 1 6 config.theme.foreground}";
    };
  };
}
